...
from alphaswarm.agents.sailing_agent import SailingQuoteAgent
...
def execute(context: ExecuteContext, req: ExecuteRequestBody) -> ExecuteResponse:
    try:
        ...
        # Create and use the SailingQuoteAgent
        agent = SailingQuoteAgent()
        agent_result = agent.get_quote(text_value)
